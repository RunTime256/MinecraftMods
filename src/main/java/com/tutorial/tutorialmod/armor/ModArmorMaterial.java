package com.tutorial.tutorialmod.armor;
...
{
    RUBY(TutorialMod.MOD_ID + ":ruby", 25, new int[] {2, 5, 6, 2}, 18,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0, () -> Ingredient.fromItems(RegistryHandler.RUBY.get()), 0);
